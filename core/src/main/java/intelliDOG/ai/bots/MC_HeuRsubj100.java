 ...
 * The cards are distributed according to the subjective probability. 
 ...
 * He uses a heuristic to finish a round and performs 100 simulations.  
 */
public class MC_HeuRsubj100  implements IBot {
	...
	public MC_HeuRsubj100(BotBoard bb, InformationGatherer ig){
		this.bb = bb;
		this.ig = ig;
	...
	public Move makeMove() {
		...
		msg.debug(this, "reduced moves: " + moves.size()); 
		msg.debugLegalMoves(this, moves);
		...
		sim = new MCSimulation(ig, bb, 100 , MCSimulation.DEAL_CARDS_ONCE, MCSimulation.USE_SUBJ_PROB, MCSimulation.ROULETTE_SELECTION); 
	...
	class SimThread extends Thread {
		...
		public void run() 
		{
			...
			for(int m = 0; m < moves.size(); m++)
			{
				...
				if(s > bestScore) 
				{
					msg.debugMove(this, moves.get(m));
					bestScore = s;  
