...
public class RulesTest {
	...
	@Test
	public void testGetMovablePiecesInGameForPlayer1(){
		board[79] = 5;
		board[78] = 5;
		board[21] = 4;
		assertArrayEquals(new int[] {21}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P4, Cards.CLUBS_ACE));
	}
	
	@Test
	public void testGetMovablePiecesInGameForPlayer2(){
		board[79] = 5;
		board[78] = 5;
		board[47] = 4;
		board[48] = 5;
		assertArrayEquals(new int[] {48}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P4, Cards.CLUBS_ACE));
		assertArrayEquals(new int[] {48, 47}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P4, Cards.CLUBS_SEVEN));
		assertArrayEquals(new int[] {48, 47}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P4, Cards.SPADES_FOUR));
		assertArrayEquals(new int[] {47}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P4, Cards.SPADES_JACK));
	}
	
	@Test
	public void testGetMovablePiecesInGameForPlayer3(){
		board[67] = 5;
		board[66] = 5;
		board[31] = 1;
		board[32] = 5;
		board[0] = 5;
		assertArrayEquals(new int[] {0}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P1, Cards.CLUBS_ACE));
		assertArrayEquals(new int[] {0}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P1, Cards.CLUBS_SEVEN));
		assertArrayEquals(new int[] {31, 0}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P1, Cards.SPADES_FOUR));
		assertArrayEquals(new int[] {31}, Rules.getInstance().getMovablePiecesInGameForPlayer(board, Players.P1, Cards.SPADES_JACK));
	}
