...
public abstract class Statistics {
	...
	public static Map<Long, String[]> getTimeMap() {
		return timeMap;
	}

	public static Stack<Long> getOpenMethodStack() {
		return openMethodStack;
	}
	...
	public static int getPieceCount1() {
		return pieceCount1;
	}

	public static int getPieceCount2() {
		return pieceCount2;
	}
