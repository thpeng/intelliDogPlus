 ...
 * The cards are distributed according to the objective probability of cards as well
 * as a probability reduction by observing enemy's moves. 
 ...
 */
public class MC_RdmRSubj100  implements IBot {
	...
	public MC_RdmRSubj100(BotBoard bb, InformationGatherer ig){
		this.bb = bb;
		this.ig = ig; 
	}
	...
	public Move makeMove() {
		...
		msg.debug(this, "number of cpu's: " + cpu); 
